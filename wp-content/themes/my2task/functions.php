<?php
/**
 * My2Task functions and definitions
 *
...
if ( ! function_exists( 'my2task_setup' ) ) :
	/**
	 ...
	 */
	function my2task_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on My2Task, use a find and replace
		 * to change 'my2task' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'my2task', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'my2task_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'my2task_setup' );
 ...
 */
function my2task_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'my2task_content_width', 640 );
}
add_action( 'after_setup_theme', 'my2task_content_width', 0 );
 ...
 */
function my2task_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'my2task' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'my2task' ),
...
add_action( 'widgets_init', 'my2task_widgets_init' );
...
function my2task_scripts() {
	...
	wp_enqueue_script( 'my2task-owl', get_template_directory_uri() . '/assets/js/owl.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'my2task-slick', get_template_directory_uri() . '/assets/js/slick.js', array(), _S_VERSION, true );
